            ...
            >
                ...
                sm:h-[190px] ' >
                    <div className='bg-red-500 h-[100%] w-[50%]  '>
                        <img className=' ' src="./img/mujer/tenni12.png" alt="Product Tennni" />
                    </div>
                </SwiperSlide>
                <SwiperSlide className='bg-transparent h-[120px]
                sm:h-[190px] ' >
                    <div className='h-[100%] w-[50%]  '>
                        <img className=' ' src="./img/mujer/sandalia3.png" alt="Product Tennni" />
                    </div>
                </SwiperSlide>
                <SwiperSlide className='bg-transparent h-[120px]
                sm:h-[190px] ' >
                    <div className='h-[100%] w-[50%]  '>
                        <img className=' ' src="./img/mujer/tenni1.png" alt="Product Tennni" />
                    </div>
                </SwiperSlide>
                <SwiperSlide className='bg-transparent h-[120px]
                sm:h-[190px] ' >
                    <div className='h-[100%] w-[50%]  '>
                        <img className=' ' src="./img/mujer/sandalia6.png" alt="Product Tennni" />
                    </div>
                </SwiperSlide>
                <SwiperSlide className='bg-transparent h-[120px]
                sm:h-[190px] ' >
                    <div className='h-[100%] w-[50%]  '>
                        <img className=' ' src="./img/mujer/tenni2.png" alt="Product Tennni" />
                    </div>
                </SwiperSlide>
